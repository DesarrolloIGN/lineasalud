        ...
        height: 55%;
                  ...
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                           <div><center><em><h4 style="color:#062334;">¡Estás a menos de 1 paso de <strong>ahorrar</strong> en tu seguro médico!
</h4></em></center>
                           </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                    ...
                    <div class="container">
                        <div class="row">
                           <div class="col-xs-0 col-sm-3 col-md-0 col-lg-3">
                             
                           </div>
                           <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="margin-top: 1%;">
                              <img src="imagenes/step4_adelante/personasasegurar.png" class="panel" alt="arriba" style="position: absolute;width: 94%;">
                              <div class="container">
                                 <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                        <form action ="step3_5.php" method="get" id="form1">
                                            <div class="form-group">
                                       <button name="np"  style="margin-left: -2.5%;" value=1 class="p2m"><img src="imagenes/step4_adelante/1p.png" alt="arriba" ></button>
                                       <button name="np" style="margin-left: -2.5%;" value=2 class="p2" ><img src="imagenes/step4_adelante/2p.png" alt="arriba" > </button>
                                       <button name="np"  style="margin-left: -2.5%;" value=3 class="p2" ><img src="imagenes/step4_adelante/3p.png" alt="arriba"> </button>
                                       <button  name="np" style="margin-left: -2.5%;"  value=4 class="p2" ><img src="imagenes/step4_adelante/4p.png" alt="arriba" > </button>
                              ...
                              <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                  <center><img src="imagenes/barraprogresion4h.png" alt="arriba" id="prbrh" ></center>
                              </div>
                           </div>
                           <div class="col-xs-0 col-sm-3 col-md-3 col-lg-3">
                             <img src="imagenes/barraprogresion4.png" alt="arriba" id="prbr">
                           </div>
                        </div>
                     </div>
                  </div>
                ...
                <div class="container">
                     ...
                     <div class="row">
                         ...
                         <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                             <center><img src="imagenes/step1/a3.png"  name="np" class="np"
                                          value=1 style="width: 50%;height: 50%;"><br><br><p style="font-size:120%;">Completa tus datos para acceder al mejor presupuesto de salud.</p></center><br>
                         </div>
                         <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
         ...
         <script type="text/javascript">
            $( document ).ready(function() {
                ...
                localStorage.setItem("ec",<?php echo $_GET["ec"];?>)
