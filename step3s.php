                ...
                <div class="container">
                                 <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 4%;" id="felicitacion">
                                        ...
                                        <center><button style="position: fixed;bottom: 0;font-size: 20px;right: 0;width: 100vw;height: 6vh;max-width: 100%;left: 0;" id="noquiero" type="button" class="btn btn-secondary">No he solicitado esta información</button></center>
         ...
         <script type="text/javascript">
            $( document ).ready(function() {
                ...
                $( "#noquiero" ).click(function() {
                    ...
                    alert("Gracias, su solicitud ha sido atendida");
            ...
            //window.location.href="step3.html";
                ...
                var id_buyer = url.searchParams.get("id_buyer");
