                  ...
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                            <br><div><center><h3><strong>¡ESTÁS MAS CERCA DE AHORRAR!</strong></h3></center>
            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                        </div>
                     ...
                     <div class="container" id="grande" >
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
                              ...
                              <h3 style="color:white;"><center>Te hemos enviado un SMS para verificar tu identidad y recibir tu OFERTA PERSONALIZADA.</center></h3>
                                       
                               <center><img id="movil" src="imagenes/movil.png"></center>
